...
import { toast, Toaster } from 'react-hot-toast'  // Import toast and Toaster here
...
function AdoptPet() {
  ...
  const toggleFavorite = (petId) => {
    if (favorites.includes(petId)) {
      ...
      toast.success('Removed from Favorites!')  // Display toast when removed
    } else {
      setFavorites([...favorites, petId])
      toast.success('Added to Favorites!')  // Display toast when added
    }
  }

  const addToCart = (pet) => {
    toast.success(`${pet.name} added to your cart!`)  // Display toast when added to cart
  }
