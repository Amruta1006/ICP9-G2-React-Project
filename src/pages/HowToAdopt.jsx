    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-b from-pink-100 to-white py-16 flex-grow">
        ...
        <p className="text-center text-black text-lg max-w-3xl mx-auto mb-12">
          Adopting a pet is a life-changing experience. Follow these simple steps to bring home a new furry friend! 🐶🐱🐰
        </p>

        {/* Steps Section */}
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 px-4">
          {[
            { icon: FaSearch, title: "1. Find a Pet", description: "Browse our pets and choose the one that fits your home & lifestyle." },
            { icon: FaClipboardCheck, title: "2. Submit an Application", description: "Fill out an adoption form to help us understand your needs." },
            { icon: FaPaw, title: "3. Meet & Greet", description: "Meet the pet in person to see if it's the perfect match!" },
        ...
        {/* Call-to-Action */}
        <div className="mt-16 bg-[#F5E6CA] py-12 text-center rounded-xl max-w-4xl mx-auto px-6 shadow-lg hover:shadow-xl transition">
