      ...
      <div className="md:w-[600px] md:ml-20 w-full bg-[#fffdf9] shadow-lg rounded-lg text-center border-blue-100-4 ">
        ...
        <div className="mt-6 space-x-4 md:space-x-9">
          <button
            ...
            className="bg-[#efd394] px-5 py-2 mb-2 md:mb-0 rounded-lg shadow-md  text-black hover:bg-[#8B5E3C] hover:text-white transition"
          >
            Edit Profile
          </button>
          <button
            onClick={handleSignOut}
            className="bg-red-400 text-black px-5 py-2  mb-2 md:mb-0 rounded-lg shadow-md hover:bg-red-600 transition"
          >
            Sign Out
          </button>
        </div>
