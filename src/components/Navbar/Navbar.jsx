...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#F5E6CA] shadow-md py-4 px-6 relative">
      ...
      {isOpen && (
        <ul className="absolute top-full left-0 w-full bg-[#F5E6CA] shadow-md md:hidden flex flex-col items-center space-y-4 py-4 z-50">
